<?php
	...
	$dir =  '/Users/Michael/Dropbox/Filologi/Workspace/Projects/kardinaldyderne/ordstudier/tools/Betacode/'.$filename;
	$content = file_get_contents($dir);
	
	$new_file = $dir.'_utf.txt';
//	$handle = fopen($filename, 'w') or die('Cannot open file: '.$new_file);
	file_put_contents($new_file, convertFromBetaCode($content));
	
//	echo convertFromBetaCode($content);
	echo "Success!";	
	?>